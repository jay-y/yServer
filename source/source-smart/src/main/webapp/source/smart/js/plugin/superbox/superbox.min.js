...
!function (a) {
    a.fn.SuperBox = function (requestUrl) {
        var b = a('<div class="superbox-show"></div>'),
            c = a('<img src="" class="superbox-current-img"><div id="imgInfoBox" class="superbox-imageinfo inline-block"> ' +
                '<h1>Image Title</h1><span><!--<p><em>http://imagelink.com/thisimage.jpg</em></p>--><p class="superbox-img-description">Image description</p>' +
                '<p><a href="' + requestUrl + '" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#remoteModal">NEXT</a> ' +
                '<a href="javascript:void(0);" class="btn btn-danger btn-sm sbox-close">CANCEL</a>' +
                '</p></span> </div>'),
        ...
        return this.each(function () {
            ...
            }), a(".superbox").on("click", ".superbox-close,.sbox-close", function () {
