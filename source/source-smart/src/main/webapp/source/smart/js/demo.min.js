...
$("#main").append('<div class="demo">' +
    ...
    '<a href="javascript:void(0);" id="smart-style-0" data-skinlogo="'+sourcePath+'img/logo.png" class="btn btn-block btn-xs txt-color-white margin-right-5" style="background-color:#4E463F;">Smart Default</a>' +
    '<a href="javascript:void(0);" id="smart-style-1" data-skinlogo="'+sourcePath+'img/logo-white.png" class="btn btn-xs btn-block btn-xs txt-color-white" style="background:#3A4558;">Dark Elegance</a>' +
    '<a href="javascript:void(0);" id="smart-style-2" data-skinlogo="'+sourcePath+'img/logo-blue.png" class="btn btn-xs btn-block txt-color-darken margin-top-5" style="background:#fff;">Ultra Light</a>' +
    '<a href="javascript:void(0);" id="smart-style-3" data-skinlogo="'+sourcePath+'img/logo-pale.png" class="btn btn-xs btn-block txt-color-white margin-top-5" style="background:#f78c40">Google Skin</a>' +
    '<a href="javascript:void(0);" id="smart-style-4" data-skinlogo="'+sourcePath+'img/logo-pale.png" class="btn btn-xs btn-block txt-color-white margin-top-5" style="background: #bbc0cf; border: 1px solid #59779E; color: #17273D !important;">PixelSmash</a> ' +
    '<a href="javascript:void(0);" id="smart-style-5" data-skinlogo="'+sourcePath+'img/logo-pale.png" class="btn btn-block txt-color-white margin-top-5" style="background: rgba(153, 179, 204, 0.2); border: 1px solid rgba(121, 161, 221, 0.8); color: #17273D !important;"><i class="fa fa-check fa-fw" id="skin-checked"></i>Glass <sup>beta</sup></a>' +
    '</section></form> </div>');
