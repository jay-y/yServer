...
!function (a) {
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        ...
        "del": {"caption": "<span><i class='fa fa-warning text-warning'></i>删除</span>", "msg": "是否确认删除已选择的数据?", "bSubmit": "确定", "bCancel": "取消"},
        "nav": {
            "edittext": "",
            ...
            "alertcap": "<span><i class='fa fa-warning text-warning'></i>警告</span>",
            "alerttext": "请选择一行数据",
            "viewtext": "",
        ...
        "errors": {
            "errcap": "<span><i class='fa fa-exclamation-circle text-danger'></i>Error</span>",
            "nourl": "No url is set",
