...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen"
          href="${ctxSource}/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" media="screen"
          href="${ctxSource}/css/font-awesome.min.css">
    <!-- SmartAdmin Styles : Caution! DO NOT change the order -->
    <link rel="stylesheet" type="text/css" media="screen"
          href="${ctxSource}/css/smartadmin-production-plugins.min.css">
    <link rel="stylesheet" type="text/css" media="screen"
          href="${ctxSource}/css/smartadmin-production.min.css">
    <link rel="stylesheet" type="text/css" media="screen"
          href="${ctxSource}/css/smartadmin-skins.min.css">
    <!-- SmartAdmin RTL Support -->
    <link rel="stylesheet" type="text/css" media="screen"
          href="${ctxSource}/css/smartadmin-rtl.min.css">

    <!-- Demo purpose only: goes with demo.js, you can delete this css when designing your own WebApp -->
    <link rel="stylesheet" type="text/css" media="screen"
          href="${ctxSource}/css/demo.min.css">
    <!-- #FAVICONS -->
    <link rel="shortcut icon" href="${ctxSource}/img/favicon/favicon.ico"
          type="image/x-icon">
    <link rel="icon" href="${ctxSource}/img/favicon/favicon.ico"
          type="image/x-icon">

    <!-- #APP SCREEN / ICONS -->
    <!-- Specifying a Webpage Icon for Web Clip
            Ref: https://developer.apple.com/library/ios/documentation/AppleApplications/Reference/SafariWebContent/ConfiguringWebApplications/ConfiguringWebApplications.html -->
    <link rel="apple-touch-icon" href="${ctxSource}/img/splash/sptouch-icon-iphone.png">
    <link rel="apple-touch-icon" sizes="76x76"
          href="${ctxSource}/img/splash/touch-icon-ipad.png">
    <link rel="apple-touch-icon" sizes="120x120"
          href="${ctxSource}/img/splash/touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon" sizes="152x152"
          href="${ctxSource}/img/splash/touch-icon-ipad-retina.png">
    <!-- iOS web-app metas : hides Safari UI Components and Changes Status Bar Appearance -->
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <!-- Startup image for web apps -->
    <link rel="apple-touch-startup-image"
          href="${ctxSource}/img/splash/ipad-landscape.png"
          media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
    <link rel="apple-touch-startup-image"
          href="${ctxSource}/img/splash/ipad-portrait.png"
          media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
    <link rel="apple-touch-startup-image"
          href="${ctxSource}/img/splash/iphone.png"
...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <img src="${ctxSource}/img/logo-pale.png" alt="Admin"></span>
    ...
    <div class="pull-right">
        ...
        <ul id="mobile-profile-img"
            ...
            <li class=""><a href="#"
                    ...
                    src="${ctxSource}/img/avatars/sunny.png" alt="John Doe"
                    class="online"/>
            </a>
                <ul class="dropdown-menu pull-right">
                    ...
                    <li class="divider"></li>
                    <li><a href="${ctxSource}/ajax/profile.html"
                           class="padding-10 padding-top-0 padding-bottom-0"> <i
        ...
        <form action="https://www.baidu.com/s"
            ...
            <button type="button" onclick="window.open('https://www.baidu.com/s?wd='+document.getElementById('search-fld').value)">
        ...
        <ul class="header-dropdown-list hidden-xs">
            <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="${ctxSource}/img/blank.gif" class="flag flag-cn"
                     alt="China(mainland)"> <span> 中文（简体）</span> <i
                    class="fa fa-angle-down"></i>
            </a>
                <ul class="dropdown-menu pull-right">
                    <li class="active"><a href="javascript:void(0);"><img
                            src="${ctxSource}/img/blank.gif" class="flag flag-cn"
                            alt="China"> 中文（简体）</a></li>
                    <!--<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-us" alt="United States"> English (US)</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-fr" alt="France"> Français</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-es" alt="Spanish"> Español</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-de" alt="German"> Deutsch</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-jp" alt="Japan"> 日本語</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-it" alt="Italy"> Italiano</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-pt" alt="Portugal"> Portugal</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-ru" alt="Russia"> Русский язык</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${ctxSource}/img/blank.gif" class="flag flag-kr" alt="Korea"> 한국어</a>
							</li>-->
...
<aside id="left-panel">
			...
			<span> <!-- User image size is adjusted inside CSS, it should stay as is -->
				...
				<a href="javascript:void(0);" id="show-shortcut"
                   data-action="toggleShortcut"> <img
                        src="${ctxSource}/img/avatars/sunny.png" alt="我" class="online"/>
					<span> Admin </span> <i
                            class="fa fa-angle-down"></i>
			</a>
    ...
    <nav>
        <!--
            ...
            -->
        <ul>
            <li class=""><a href="a/user/info" title="首页"><i
            ...
            <%-- <li class="top-menu-invisible">
                    ...
                    <ul>
                        <li>
                            <a href="${ctxSource}/ajax/difver.html"><i class="fa fa-stack-overflow"></i> Different Versions</a>
                        </li>
                        <li>
                            <a href="${ctxSource}/ajax/applayout.html"><i class="fa fa-cube"></i> App Settings</a>
                        </li>
                        <li>
    ...
    <%-- <a href="${ctxSource}/ajax/difver.html" class="btn btn-primary nav-demo-btn">AngularJS, PHP and .Net Versions</a> --%>
...
<script src="${ctxSource}/js/libs/jquery-2.1.1.min.js"></script>
<script src="${ctxSource}/js/libs/jquery-ui-1.10.3.min.js"></script>

<!-- IMPORTANT: APP CONFIG -->
<script src="${ctxSource}/js/app.config.js"></script>
<script type="text/javascript">
    $.sound_path = "${ctxSource}/sound/";
</script>

<!-- JS TOUCH : include this plugin for mobile drag / drop touch events-->
<script
        src="${ctxSource}/js/plugin/jquery-touch/jquery.ui.touch-punch.min.js"></script>
<!-- BOOTSTRAP JS -->
<script src="${ctxSource}/js/bootstrap/bootstrap.min.js"></script>
<!-- CUSTOM NOTIFICATION -->
<script src="${ctxSource}/js/notification/SmartNotification.min.js"></script>
<!-- JARVIS WIDGETS -->
<script src="${ctxSource}/js/smartwidgets/jarvis.widget.min.js"></script>
<!-- EASY PIE CHARTS -->
<script
        src="${ctxSource}/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>
<!-- SPARKLINES -->
<script src="${ctxSource}/js/plugin/sparkline/jquery.sparkline.min.js"></script>
<!-- JQUERY VALIDATE -->
<script
        src="${ctxSource}/js/plugin/jquery-validate/jquery.validate.min.js"></script>

<script
        src="${ctxSource}/js/plugin/bootstrapvalidator/bootstrapValidator.min.js"></script>
<script
        src="${ctxSource}/js/plugin/bootstrapvalidator/language/zh_CN.min.js"></script>
<!-- JQUERY MASKED INPUT -->
<script
        src="${ctxSource}/js/plugin/masked-input/jquery.maskedinput.min.js"></script>
<!-- JQUERY SELECT2 INPUT -->
<script src="${ctxSource}/js/plugin/select2/select2.min.js"></script>
<!-- JQUERY UI + Bootstrap Slider -->
<script
        src="${ctxSource}/js/plugin/bootstrap-slider/bootstrap-slider.min.js"></script>
<!-- browser msie issue fix -->
<script src="${ctxSource}/js/plugin/msie-fix/jquery.mb.browser.min.js"></script>

<!-- FastClick: For mobile devices: you can disable this in app.js -->
<script src="${ctxSource}/js/plugin/fastclick/fastclick.min.js"></script>
...
<!-- Demo purpose only -->
<script src="${ctxSource}/js/demo.min.js"></script>

<!-- MAIN APP JS FILE -->
<%-- 		<script src="${ctxSource}/js/app.min.js"></script> --%>
<script src="${ctxSource}/js/app.custom.js"></script>

<!-- ENHANCEMENT PLUGINS : NOT A REQUIREMENT -->
<!-- Voice command : plugin -->
<script src="${ctxSource}/js/speech/voicecommand.min.js"></script>

<!-- SmartChat UI : plugin -->
<script src="${ctxSource}/js/smart-chat-ui/smart.chat.ui.min.js"></script>
<script src="${ctxSource}/js/smart-chat-ui/smart.chat.manager.min.js"></script>

<%--<script--%>
<%--src="${commonSource}/mustache.min.js"--%>
<%--type="text/javascript"></script>--%>
<%--<script--%>
<%--src="${commonSource}/prototype.min.js"--%>
<%--type="text/javascript"></script>--%>
<%--<script--%>
<%--src="${commonSource}/jeesite.min.js"--%>
<%--type="text/javascript"></script>--%>
<script type="text/javascript">
    /**
     * ajax提交表单
    ...
    function loadSubmit(a, b, date, hasSerialize) {
        hasSerialize = (null == hasSerialize || undefined == hasSerialize) ? true : hasSerialize;
        if (hasSerialize) {
