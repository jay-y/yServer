...
@DataSource("default")
@Transactional
public abstract class TmpBaseServiceImpl<T extends BaseEntity, DAO extends JpaBaseDao<T, Serializable>> extends JpaBaseServiceImpl<T, Serializable, DAO> implements TmpBaseService<T, DAO>
{
}
