...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-lg fa-fw fa-user"></i>支付设置
        </h1>
    </div>
</div>
<!-- widget grid -->
...
<script type="text/javascript">
    ...
    // 数据请求
    var dataUrl = "${ctxRequest}/payment/data";
    // 新增请求
    var formUrl = "${ctxRequest}/payment/form";
    // 删除请求
    var delUrl = "${ctxRequest}/payment/delete";
        ...
        var columns = [
            ...
            },
            {
                ...
                "mRender": function (cell, b, row, d) {
                    return yjs.checkNotEmpty(cell) ? "已设置" : "未设置";
                },
                "width": 100
            },
            {
