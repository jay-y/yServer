    ...
    <div id="content" class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
                <h1 class="txt-color-red login-header-big">Universal Manager System</h1>
                <div class="hero">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
                <div class="well no-padding">
                    <form action="${ctxRequest}/login" id="login-form" method="post" class="smart-form client-form">
                        <header>
                            登录
                        </header>
