...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-lg fa-fw fa-user"></i>物流管理
        </h1>
    </div>
</div>
<!-- widget grid -->
...
<script type="text/javascript">
    ...
    // 数据请求
    var dataUrl = "${ctxRequest}/logistics/data";
    // 新增请求
    var formUrl = "${ctxRequest}/logistics/form";
    // 删除请求
    var delUrl = "${ctxRequest}/logistics/delete";
        ...
        var columns = [
            ...
            },
            {
                ...
                "mRender": function (cell, b, row, d) {
                    return '<img src="' + cell + '" style="width: auto;height: 100px;" onerror="this.src=\'${smartSource}/img/mybg.png\'"/>';
                },
                "width": 120
            },
            {
